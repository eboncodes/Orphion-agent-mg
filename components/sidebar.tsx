...
import { ChevronDown, ChevronRight, Home, Menu, PanelRightClose, PanelRightOpen, Archive, X, Bell, MessageSquare } from "lucide-react"
        ...
        <div className="h-full w-full bg-black flex flex-col animate-slideDown">
          ...
          <div className="border-t border-neutral-800">
            <div className="p-4 space-y-2">
              {/* Announcements button with popover */}
              <Popover>
                <PopoverTrigger asChild>
                  <div
                    className={`flex items-center transition-all duration-300 cursor-pointer font-serif ${
                      isOpen
                        ? "px-2 py-1.5 text-neutral-400 hover:bg-neutral-800/50 hover:text-white rounded-md"
                  ...
                  >
                    ...
                    {isOpen && <span className="ml-2 transition-opacity duration-300 opacity-100 font-serif">Announcements</span>}
                  </div>
                </PopoverTrigger>
                <PopoverContent side="right" align="start" className="w-64">
                  <div className="text-white font-semibold mb-1">Version 2.0.0</div>
                  <div className="text-neutral-300 text-sm">Welcome to Orphion 2.0.0!<br/>- New sidebar design<br/>- Announcements panel<br/>- UI improvements<br/>- Bug fixes and more</div>
                </PopoverContent>
              </Popover>
            </div>
          </div>
        ...
        >
          ...
          {isOpen ? (
            ...
            <div className="flex flex-col items-center mb-4 space-y-2">
              <Popover>
                <PopoverTrigger asChild>
                  <div className="p-2 text-neutral-400 hover:text-white hover:scale-110 transition-all duration-300" role="button" aria-label="Announcements">
                    <Bell size={20} />
                  </div>
                </PopoverTrigger>
                <PopoverContent side="right" align="start" className="w-64">
